(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("premiere", [], factory);
	else if(typeof exports === 'object')
		exports["premiere"] = factory();
	else
		root["premiere"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Api_1 = __webpack_require__(299);
	exports.Api = Api_1.default;
	var Cache_1 = __webpack_require__(300);
	exports.Cache = Cache_1.default;
	var Model_1 = __webpack_require__(326);
	exports.Model = Model_1.default;
	var Store_1 = __webpack_require__(327);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Cache_1 = __webpack_require__(300);
	var axios_1 = __webpack_require__(301);
	/**
	...
	var Api = (function () {
	     ...
	     */
	    Api.prototype.cachePromise = function (name, fn) {
	        var _this = this;
	        if (!this.usePromiseCache) {
	            return new Promise(fn);
	        }
	        var cached = this.cache.getPromise(name);
	        if (cached) {
	            return cached;
	        }
	        ...
	        var destroyCallback = function () {
	            _this.cache.destroyPromise(name);
	        };
	     ...
	     */
	    Api.setJwtToken = function (token) {
	        this.headers['Authorization'] = "Bearer " + token;
	    };
	    /**
	     * Remove Jwt authorization header
	     */
	    Api.removeJwtToken = function () {
...
/***/ function(module, exports) {
	...
	var Cache = (function () {
	     ...
	     * Get key from value
	     */
	    Cache.resolveKey = function (value) {
	     ...
	     */
	    Cache.prototype.enabled = function () {
	     ...
	     */
	    Cache.prototype.where = function (property, value) {
	        var _this = this;
	        if (this.enabled()) {
	            var values = Object.keys(this.objects).map(function (key) { return _this.objects[key]; });
	            return values.find(function (object) {
	     ...
	     * Set object
	     */
	    Cache.prototype.set = function (value, clearLists) {
	        var _this = this;
	        if (clearLists === void 0) { clearLists = true; }
	        if (Array.isArray(value)) {
	            var list = value;
	            return list.map(function (it) { return _this.set(it, clearLists); });
	        }
	        var object = value;
	        if (this.enabled()) {
	     ...
	     * Remove object
	     */
	    Cache.prototype.destroy = function (value) {
	        var self = this.constructor;
	     ...
	     * Get list by name
	     */
	    Cache.prototype.getList = function (name) {
	        if (this.enabled()) {
	     ...
	     * Set list by name
	     */
	    Cache.prototype.setList = function (name, list) {
	        if (this.enabled()) {
	            this.lists[name] = list;
	        }
	        return list;
	    };
	    Cache.prototype.destroyList = function (name) {
	        delete this.lists[name];
	    };
	    /**
	     * Get promise by name
	     */
	    Cache.prototype.getPromise = function (name) {
	     ...
	     * Set promise by name
	     */
	    Cache.prototype.setPromise = function (name, promise) {
	        if (this.api.usePromiseCache) {
	     ...
	     */
	    Cache.prototype.destroyPromise = function (name) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	axios.isCancel = __webpack_require__(320);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dispatchRequest = __webpack_require__(318);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getDefaultAdapter() {
	  ...
	  if (typeof XMLHttpRequest !== 'undefined') {
	    ...
	    adapter = __webpack_require__(308);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(315);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(303);
	var transformData = __webpack_require__(319);
	var isCancel = __webpack_require__(320);
	var defaults = __webpack_require__(306);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Model = (function () {
	     ...
	     */
	    Model.resolveStore = function (properties, modelClass) {
	        if (properties === void 0) { properties = this.storeProperties; }
	        if (modelClass === void 0) { modelClass = this; }
	        return this.store = this.store || new Store_1.default(modelClass, properties);
	    };
	    /**
	     ...
	     */
	    Model.make = function (values) {
	        var _this = this;
	        if (Array.isArray(values)) {
	            return values.map(function (it) { return _this.make(it); });
	        }
	     ...
	     */
	    Model.prototype.denormalized = function () {
	        return {};
	    };
	    /**
	     ...
	     */
	    Model.find = function (key, options) {
	     ...
	     */
	    Model.save = function (values, options) {
	        var _this = this;
	        if (options === void 0) { options = undefined; }
	        if (Array.isArray(values)) {
	            return values.map(function (it) { return _this.save(it); });
	        }
	    ...
	    Model.prototype.destroy = function (options) {
	        if (options === void 0) { options = undefined; }
	        var self = this.constructor;
	        return self.destroy(this.key(), options);
	    };
	    /**
	     * Destroy
	     */
	    Model.destroy = function (key, options) {
	        var _this = this;
	        if (options === void 0) { options = undefined; }
	        if (Array.isArray(key)) {
	            return key.map(function (it) { return _this.destroy(it); });
	        }
	     ...
	     * Get promise to belongsTo FK relation
	     */
	    Model.belongsTo = function (model, value, options) {
	        if (options === void 0) { options = undefined; }
	     ...
	     */
	    Model.prototype.belongsToMany = function (model, options) {
	        if (options === void 0) { options = undefined; }
	        var self = this.constructor;
	     ...
	     * Get promise to belongsToMany FK relation
	     */
	    Model.belongsToMany = function (model, value, options) {
	        if (options === void 0) { options = undefined; }
	     ...
	     */
	    Model.hasOne = function (model, key, options) {
	        var _this = this;
	        if (options === void 0) { options = undefined; }
	        return new Promise(function (resolve, reject) {
	            _this.hasMany(model, key, options).then(function (objects) {
	     ...
	     */
	    Model.hasMany = function (model, key, options) {
	        if (options === void 0) { options = undefined; }
	     ...
	     */
	    Model.prototype.act = function (action, options) {
	        if (options === void 0) { options = undefined; }
	        var self = this.constructor;
	     ...
	     * Call action
	     */
	    Model.act = function (key, action, options) {
	        if (options === void 0) { options = undefined; }
	     ...
	     */
	    Model.where = function (property, key, options) {
	        if (options === void 0) { options = undefined; }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = (function (_super) {
	    ...
	    function Store(model, properties) {
	        if (properties === void 0) { properties = {}; }
	     ...
	     */
	    Store.prototype.isMethodAllowed = function (method) {
	     ...
	     * @throws Error
	     */
	    Store.prototype.verifyPermission = function (method) {
	        if (!this.isMethodAllowed(method)) {
	            var message = "Method '" + method + "' is not allowed in '" + this.model.path + "' store";
	     ...
	     */
	    Store.prototype.modelInstance = function (values) {
	        return this.model.make(values);
	    };
	    /**
	     * Get new normalized model instance
	     */
	    Store.prototype.normalizedModel = function (values) {
	        var _this = this;
	        if (Array.isArray(values)) {
	            return values.map(function (hash) { return _this.normalizedModel(hash); });
	        }
	        var instance = this.modelInstance(values);
	        instance.normalize();
	        return instance;
	    };
	    /**
	     * Get index
	     */
	    Store.prototype.index = function (options) {
	        var _this = this;
	        if (options === void 0) { options = {}; }
	        if (!options.permit) {
	            this.verifyPermission('index');
	        }
	        return this.cachePromise('index', function (resolve, reject) {
	            var list = _this.cache.getList('index');
	            if (!options.ignoreCache && list) {
	                if (list) {
	                    return resolve(list);
	                }
	            }
	            var promise = _this.http().get(options.url || '');
	            promise.then(function (response) {
	                var list = _this.normalizedModel(response.data);
	                _this.cache.setList('index', list);
	                if (_this.setIndex) {
	                    _this.cache.set(list, false);
	                }
	                resolve(list);
	            }, reject);
	        });
	    ...
	    Store.prototype.get = function (key, options) {
	        ...
	        key = Cache_1.default.resolveKey(key);
	        return this.cachePromise("get/" + key, function (resolve, reject) {
	            if (!options.ignoreCache) {
	                var object = _this.cache.get(key);
	                if (object) {
	                    return resolve(object);
	                }
	            }
	            var promise = _this.http().get(options.url || key.toString());
	            promise.then(function (response) {
	                var instance = _this.normalizedModel(response.data);
	                resolve(_this.cache.set(instance, false));
	            }, reject);
	        });
	    };
	    /**
	     ...
	     */
	    Store.prototype.where = function (property, value, options) {
	        var _this = this;
	        if (options === void 0) { options = {}; }
	        if (!options.permit) {
	            this.verifyPermission('where');
	        }
	        return this.cachePromise("where/" + property + "/" + value, function (resolve, reject) {
	            if (!options.ignoreCache) {
	                var object = _this.cache.where(property, value);
	                if (object) {
	                    return resolve(object);
	                }
	            }
	     ...
	     */
	    Store.prototype.create = function (data, options) {
	        var _this = this;
	        if (options === void 0) { options = {}; }
	        this.verifyPermission('create');
	        var promise = this.http().post(options.url || '', data);
	        return new Promise(function (resolve, reject) {
	            promise.then(function (response) {
	                var instance = _this.normalizedModel(response.data);
	                resolve(_this.cache.set(instance));
	            }, reject);
	        });
	    };
	    /**
	     ...
	     */
	    Store.prototype.update = function (data, options) {
	        var _this = this;
	        if (options === void 0) { options = {}; }
	        this.verifyPermission('update');
	        return new Promise(function (resolve, reject) {
	            var promise = _this.http().put(options.url || data[_this.model.keyColumn].toString(), data);
	            promise.then(function (response) {
	                var instance = _this.normalizedModel(response.data);
	                resolve(_this.cache.set(instance));
	            }, reject);
	     ...
	     */
	    Store.prototype.destroy = function (value, options) {
	        var _this = this;
	        if (options === void 0) { options = {}; }
	        this.verifyPermission('destroy');
	        var id = Cache_1.default.resolveKey(value);
	        var promise = this.http().delete(options.url || id);
	        promise.then(function () { return _this.cache.destroy(id); });
	        return promise;
	    };
	    /**
	     * Call foreign method of store associated with given model
	     */
	    Store.prototype.by = function (model, key, options) {
	        if (options === void 0) { options = {}; }
	        return model.resolveStore().foreign(this.model, key, options);
	    };
	    /**
	     * Make http request to fetch instances by foreign key
	     */
	    Store.prototype.foreign = function (model, key, options) {
	        var _this = this;
	        if (options === void 0) { options = {}; }
	        if (!options.permit) {
	        ...
	        key = Cache_1.default.resolveKey(key);
	        var url = options.url || key + "/" + model.path;
	        return this.cachePromise("foreign/" + url, (function (resolve, reject) {
	            var list = _this.cache.getList(url);
	            if (!options.ignoreCache && list) {
	                return resolve(list);
	            }
	            _this.http().get(url).then(function (response) {
	                var list = _this.normalizedModel(response.data);
	                _this.cache.setList(url, list);
	     ...
	     * Make http to act
	     */
	    Store.prototype.act = function (key, action, options) {
	        if (options === void 0) { options = {}; }
	        if (!options.permit) {
	            this.verifyPermission('act');
	        }
	        key = Cache_1.default.resolveKey(key);
	        var url = options.url || key + "/" + action;
	        var method = this.http()[options.method || 'put'];
